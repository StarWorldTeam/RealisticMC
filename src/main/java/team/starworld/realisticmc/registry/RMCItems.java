...
public class RMCItems {
    ...
    public static final ItemEntry <HazmatGear> HAZMAT_RESPIRATOR = REGISTRATE.item("hazmat_respirator", (properties) -> new HazmatGear(ArmorItem.Type.HELMET, rl("hazmat_gear"))).register();
    public static final ItemEntry <HazmatGear> HAZMAT_OXYGEN_SUPPLIER = REGISTRATE.item("hazmat_oxygen_supplier", (properties) -> new HazmatGear(ArmorItem.Type.CHESTPLATE, rl("hazmat_gear"))).register();
    public static final ItemEntry <HazmatGear> HAZMAT_LEGGINGS = REGISTRATE.item("hazmat_leggings", (properties) -> new HazmatGear(ArmorItem.Type.LEGGINGS, rl("hazmat_gear"))).register();
    public static final ItemEntry <HazmatGear> HAZMAT_BOOTS = REGISTRATE.item("hazmat_boots", (properties) -> new HazmatGear(ArmorItem.Type.BOOTS, rl("hazmat_gear"))).register();
    ...
    public static final ItemEntry <Item> HAZMAT_GEAR_FABRIC = REGISTRATE.item("hazmat_gear_fabric", Item::new).register();
